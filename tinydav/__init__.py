...
if PYTHON2:
    from httplib import MULTI_STATUS, OK, CONFLICT, NO_CONTENT, UNAUTHORIZED, CREATED
    from urllib import quote as urllib_quote
    from urllib import urlencode as urllib_urlencode
    from StringIO import StringIO
    import httplib
else:
    from http.client import MULTI_STATUS, OK, CONFLICT, NO_CONTENT, CREATED
...
class HTTPClient(object):
    ...
    def put(self, uri, fileobject, content_type="application/octet-stream",
        ...
        data = fileobject
        if hasattr(fileobject, "read") and not PYTHON2_6:
            # python 2.5 httlib cannot handle file-like objects
            data = content.read()
...
class CoreWebDAVClient(HTTPClient):
    ...
    def lock(self, uri, scope="exclusive", type_="write", owner=None,
        ...
        try:
            ...
            if lock_response == OK or lock_response == CREATED:
